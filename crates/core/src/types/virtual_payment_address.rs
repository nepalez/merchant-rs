...
impl FromStr for VirtualPaymentAddress {
    type Err = Error;
...
impl<'a> Sanitized<'a> for VirtualPaymentAddress {
    type Input = &'a str;
...
//
// WARNING: This masking is designed for logging/debugging purposes only.
